<template><div><h2 id="_2-1-1-进程" tabindex="-1"><a class="header-anchor" href="#_2-1-1-进程" aria-hidden="true">#</a> 2.1.1 进程</h2>
<p>进程是程序的一次执行过程，是系统<strong>资源分配</strong>和调度的基本单位</p>
<p>PCB：进程控制块，描述进程信息和状态。创建进程即创建PCB，是进程存在的唯一标志</p>
<h3 id="进程的状态" tabindex="-1"><a class="header-anchor" href="#进程的状态" aria-hidden="true">#</a> 进程的状态</h3>
<ul>
<li>
...
<h4 id="进程的控制" tabindex="-1"><a class="header-anchor" href="#进程的控制" aria-hidden="true">#</a> 进程的控制</h4>
<p>进程的状态转换，使用原语</p>
<ul>
<li>
...
<h4 id="父进程和子进程的关系" tabindex="-1"><a class="header-anchor" href="#父进程和子进程的关系" aria-hidden="true">#</a> 父进程和子进程的关系</h4>
<p>父进程终止，子进程有两种选择：1.终止；2.子进程被init进程领养</p>
<p>子进程终止，资源归还父进程</p>
<p>父进程和子进程可以共享部分资源，不能同时使用临界资源</p>
<p>父进程能给子进程分配虚拟地址空间，但不共享虚拟地址空间</p>
<h4 id="进程的组织" tabindex="-1"><a class="header-anchor" href="#进程的组织" aria-hidden="true">#</a> 进程的组织</h4>
...
<h4 id="进程的通信" tabindex="-1"><a class="header-anchor" href="#进程的通信" aria-hidden="true">#</a> 进程的通信</h4>
...
<h2 id="_2-1-2-线程" tabindex="-1"><a class="header-anchor" href="#_2-1-2-线程" aria-hidden="true">#</a> 2.1.2 线程</h2>
<p>进程一旦阻塞，整个进程就会挂起，即使里面有部分函数不依赖于等待的资源也不能执行。于是引入线程，作为CPU调度的基本单位，一个进程分成多个线程。线程的本质就是函数的执行</p>
<h3 id="_1-线程的组织与控制" tabindex="-1"><a class="header-anchor" href="#_1-线程的组织与控制" aria-hidden="true">#</a> 1.线程的组织与控制</h3>
...
<h3 id="_2-线程的实现方式" tabindex="-1"><a class="header-anchor" href="#_2-线程的实现方式" aria-hidden="true">#</a> 2.线程的实现方式</h3>
<p>用户级线程：</p>
<ul>
<li>存在在用户空间中</li>
...
<h3 id="_3-多线程模型" tabindex="-1"><a class="header-anchor" href="#_3-多线程模型" aria-hidden="true">#</a> 3.多线程模型</h3>
...
<h3 id="线程池" tabindex="-1"><a class="header-anchor" href="#线程池" aria-hidden="true">#</a> 线程池</h3>
...
<h2 id="_2-2-处理机调度" tabindex="-1"><a class="header-anchor" href="#_2-2-处理机调度" aria-hidden="true">#</a> 2.2 处理机调度</h2>
<p>调度程序通过调度算法从就绪队列选择一个进程执行，并决定时间片大小</p>
<p>调度的三个层次：</p>
<p>（1）作业调度：从外存挑选作业到内存</p>
<p>（2）进程调度：就绪队列-》运行</p>
<p>（3）中级调度：将暂时不运行的程序挂起，调出内存到外存</p>
<h3 id="调度的时机" tabindex="-1"><a class="header-anchor" href="#调度的时机" aria-hidden="true">#</a> 调度的时机</h3>
<p>不能进程调度的情况：</p>
<ul>
<li>处理中断过程中</li>
...
<h3 id="进程调度方式" tabindex="-1"><a class="header-anchor" href="#进程调度方式" aria-hidden="true">#</a> 进程调度方式</h3>
<p>抢占方式：一个进程执行时，有更重要的进程来，立即暂停进程</p>
<p>非抢占方式：继续执行，直到结束或进入阻塞态才会调度</p>
<!-- <font color=red>平均周转时间=sum（各作业等待+执行时间）/n，也就是完成时间-到达时间</font> -->
<p><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mstyle mathcolor="#FF0000"><mrow><mtext>平均周转时间</mtext><mo>=</mo><mi>s</mi><mi>u</mi><mi>m</mi><mtext>（各作业等待</mtext><mo>+</mo><mtext>执行时间）</mtext><mi mathvariant="normal">/</mi><mi>n</mi><mtext>，也就是完成时间</mtext><mo>−</mo><mtext>到达时间</mtext></mrow></mstyle></mrow><annotation encoding="application/x-tex">\color{#FF0000}{平均周转时间=sum（各作业等待+执行时间）/n，也就是完成时间-到达时间}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord" style="color:#FF0000;"><span class="mord cjk_fallback" style="color:#FF0000;">平均周转时间</span><span class="mspace" style="color:#FF0000;margin-right:0.2778em;"></span><span class="mrel" style="color:#FF0000;">=</span><span class="mspace" style="color:#FF0000;margin-right:0.2778em;"></span><span class="mord mathnormal" style="color:#FF0000;">s</span><span class="mord mathnormal" style="color:#FF0000;">u</span><span class="mord mathnormal" style="color:#FF0000;">m</span><span class="mord cjk_fallback" style="color:#FF0000;">（各作业等待</span><span class="mspace" style="color:#FF0000;margin-right:0.2222em;"></span><span class="mbin" style="color:#FF0000;">+</span><span class="mspace" style="color:#FF0000;margin-right:0.2222em;"></span><span class="mord cjk_fallback" style="color:#FF0000;">执行时间）</span><span class="mord" style="color:#FF0000;">/</span><span class="mord mathnormal" style="color:#FF0000;">n</span><span class="mord cjk_fallback" style="color:#FF0000;">，也就是完成时间</span><span class="mspace" style="color:#FF0000;margin-right:0.2222em;"></span><span class="mbin" style="color:#FF0000;">−</span><span class="mspace" style="color:#FF0000;margin-right:0.2222em;"></span><span class="mord cjk_fallback" style="color:#FF0000;">到达时间</span></span></span></span></span></p>
<h3 id="典型的调度算法" tabindex="-1"><a class="header-anchor" href="#典型的调度算法" aria-hidden="true">#</a> 典型的调度算法</h3>
<ul>
<li>
...
<h2 id="_2-3-进程同步互斥" tabindex="-1"><a class="header-anchor" href="#_2-3-进程同步互斥" aria-hidden="true">#</a> 2.3 进程同步互斥</h2>
...
<h3 id="_1-互斥的四个原则" tabindex="-1"><a class="header-anchor" href="#_1-互斥的四个原则" aria-hidden="true">#</a> 1.互斥的四个原则</h3>
<ul>
...
<h3 id="_2-硬件和软件实现进程互斥" tabindex="-1"><a class="header-anchor" href="#_2-硬件和软件实现进程互斥" aria-hidden="true">#</a> 2.硬件和软件实现进程互斥</h3>
<h4 id="_1-软件实现" tabindex="-1"><a class="header-anchor" href="#_1-软件实现" aria-hidden="true">#</a> 1.软件实现</h4>
...
<h4 id="_2-硬件实现" tabindex="-1"><a class="header-anchor" href="#_2-硬件实现" aria-hidden="true">#</a> 2.硬件实现</h4>
...
<h3 id="_3-信号量-pv操作" tabindex="-1"><a class="header-anchor" href="#_3-信号量-pv操作" aria-hidden="true">#</a> 3.信号量，PV操作</h3>
...
<span class="token function">signal</span><span class="token punctuation">(</span>S<span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="信号量实现同步、互斥" tabindex="-1"><a class="header-anchor" href="#信号量实现同步、互斥" aria-hidden="true">#</a> 信号量实现同步、互斥</h4>
...
<span class="token function">P2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token function">V</span><span class="token punctuation">(</span>mutex<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="信号量实现同步关系" tabindex="-1"><a class="header-anchor" href="#信号量实现同步关系" aria-hidden="true">#</a> 信号量实现同步关系</h4>
...
<h3 id="_4-管程和条件变量" tabindex="-1"><a class="header-anchor" href="#_4-管程和条件变量" aria-hidden="true">#</a> 4.管程和条件变量</h3>
...
<h3 id="_5-经典同步互斥问题" tabindex="-1"><a class="header-anchor" href="#_5-经典同步互斥问题" aria-hidden="true">#</a> 5.经典同步互斥问题</h3>
<h4 id="生产者-消费者问题" tabindex="-1"><a class="header-anchor" href="#生产者-消费者问题" aria-hidden="true">#</a> 生产者-消费者问题</h4>
<p>缓冲区内有n个缓冲单元</p>
<p>两个同步关系：</p>
<ul>
<li>
...
<span class="token function">consumer</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span><span class="token comment">//消费者</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="读者-写者问题" tabindex="-1"><a class="header-anchor" href="#读者-写者问题" aria-hidden="true">#</a> 读者-写者问题</h4>
...
<span class="token function">reader</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="哲学家就餐问题" tabindex="-1"><a class="header-anchor" href="#哲学家就餐问题" aria-hidden="true">#</a> 哲学家就餐问题</h4>
...
<span class="token function">Pi</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="利用pv操作解题" tabindex="-1"><a class="header-anchor" href="#利用pv操作解题" aria-hidden="true">#</a> 利用PV操作解题</h3>
<p>先分析同步互斥关系，几个关系几个信号量。对于互斥，用PV夹紧互斥行为；对于同步，在a进程末尾加V，在b进程开始加P。</p>
<p>两个同步关系，一个互斥关系，需要三个信号量。</p>
<p>初始有几个资源，信号量就是初始化为几</p>
<h2 id="_2-4-死锁" tabindex="-1"><a class="header-anchor" href="#_2-4-死锁" aria-hidden="true">#</a> 2.4 死锁</h2>
...
<h3 id="死锁预防-破坏四个条件" tabindex="-1"><a class="header-anchor" href="#死锁预防-破坏四个条件" aria-hidden="true">#</a> 死锁预防：破坏四个条件</h3>
<ul>
...
<p>死锁预防不改变进程之间的关系</p>
<h3 id="死锁避免-银行家算法" tabindex="-1"><a class="header-anchor" href="#死锁避免-银行家算法" aria-hidden="true">#</a> 死锁避免：银行家算法</h3>
...
<h3 id="死锁检测-画资源分配图" tabindex="-1"><a class="header-anchor" href="#死锁检测-画资源分配图" aria-hidden="true">#</a> 死锁检测：画资源分配图</h3>
...
<h3 id="死锁解除" tabindex="-1"><a class="header-anchor" href="#死锁解除" aria-hidden="true">#</a> 死锁解除</h3>
...
<h3 id="计算题" tabindex="-1"><a class="header-anchor" href="#计算题" aria-hidden="true">#</a> 计算题</h3>
