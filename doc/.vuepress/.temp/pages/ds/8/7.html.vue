<template><div><h2 id="_8-7-外部排序" tabindex="-1"><a class="header-anchor" href="#_8-7-外部排序" aria-hidden="true">#</a> 8.7 外部排序</h2>
<ul>
<li>外部排序的基本概念
<ul>
<li>外部排序的总时间 = 内部排序所需的时间 + 外存信息读写的时间 + 内部归并所需的时间</li>
</ul>
</li>
<li>外部排序的方法</li>
<li>多路平衡归并与败者树</li>
